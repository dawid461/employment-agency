    ...
    return (
        <>
            <div
                ...
                <button onClick={openNav}><Image src='/hamburger.svg' alt='hamburger' width={24} height={22}/></button>
            </div>

            <div className='overlay' id='myNav'>
                <ul className='flex items-center flex-col overlay-content'>
                    <li>
                        <a href="javascript:void(0)" className="closebtn" onClick={closeNavMobile}>&times;</a>
                    </li>
